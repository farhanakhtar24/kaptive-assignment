...
type Props = {
	decimals: string;
	setDecimals: React.Dispatch<React.SetStateAction<string>>;
};

const DecimalSelector = ({ decimals, setDecimals }: Props) => {
	return (
		<Select
			value={decimals}
			onChange={(_, newValue) => setDecimals(newValue as string)}>
